...
| `ncl-functional-web-v1` artifacts | Make claims reproducible and inspectable | Complete file inventory | Partial: dataset, topology, arms, Presentations, learning, basins, frozen completion/reactivation evaluation, Functional Web and cardinal evidence, Recruitment, homeostasis, and activity slices exist | `test_cardinal_artifact_exposes_lifecycle_controls_interventions_and_failures` |
