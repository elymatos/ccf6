...
| `ncl-functional-web-v1` artifacts | Make claims reproducible and inspectable | Complete file inventory | Partial: dataset, topology, arms, Presentations, learning, basins, frozen completion/reactivation evaluation, Recruitment, homeostasis, and activity slices exist | `test_frozen_cues_record_completion_and_ordered_reactivation_by_arm` |
